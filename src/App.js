...
// ─── SAMPLE DATA — clears on deploy ──────────────────────────────────────────
const SEED_LEADS = [];
  { id:1, name:"Marcus Johnson", phone:"313-555-0182", email:"marcus.j@email.com", type:"Buyer", status:"Warm", city:"Detroit", zip:"48201", address:"1420 Woodward Ave", lastContact:"2025-05-18", nextFollowUp:"2025-05-26", notes:"Looking for 3BR under $280k, pre-approved", calls:3, source:"REDX", birthday:"1985-03-12", dnc:false, streak:2, tags:["Pre-approved"], aiScore:null, aiMemory:null, transaction:null },
  { id:2, name:"Tanya Rivers", phone:"248-555-0341", email:"tanya.r@email.com", type:"Seller", status:"Hot", city:"Ferndale", zip:"48220", address:"322 W 9 Mile Rd", lastContact:"2025-05-22", nextFollowUp:"2025-05-26", notes:"Expired listing, highly motivated", calls:5, source:"Expired", birthday:"1979-11-05", dnc:false, streak:5, tags:["Expired","Motivated"], aiScore:88, aiMemory:{ personality:"Direct, no-nonsense", objections:"Already tried two agents", goals:"Sell fast, best price", budget:null, timing:"ASAP", style:"Prefers calls" }, transaction:null },
  { id:3, name:"Devon Price", phone:"586-555-0897", email:"devon.p@email.com", type:"Buyer", status:"Cold", city:"St. Clair Shores", zip:"48080", address:"27000 Jefferson Ave", lastContact:"2025-04-10", nextFollowUp:"2025-05-28", notes:"Went quiet after showing, budget $320k", calls:2, source:"Referral", birthday:"1990-07-22", dnc:false, streak:0, tags:["Re-engage"], aiScore:22, aiMemory:null, transaction:null },
  { id:4, name:"Sandra Kim", phone:"313-555-0654", email:"sandra.k@email.com", type:"Seller", status:"Warm", city:"Detroit", zip:"48235", address:"18100 Livernois Ave", lastContact:"2025-05-15", nextFollowUp:"2025-05-29", notes:"Thinking about listing in 60 days", calls:4, source:"Door Knock", birthday:"1968-12-01", dnc:false, streak:1, tags:["Future listing"], aiScore:54, aiMemory:null, transaction:null },
  { id:5, name:"James Okafor", phone:"734-555-0229", email:"james.o@email.com", type:"Buyer", status:"Hot", city:"Dearborn", zip:"48124", address:"13000 Michigan Ave", lastContact:"2025-05-23", nextFollowUp:"2025-05-26", notes:"Ready to make offers now, pre-approved $400k", calls:7, source:"Zillow", birthday:"1988-09-14", dnc:false, streak:7, tags:["Active buyer","Pre-approved"], aiScore:95, aiMemory:{ personality:"Eager, decisive", objections:"None", goals:"Find home ASAP", budget:"$400k", timing:"Now", style:"Texts preferred" }, transaction:null },
  { id:6, name:"Ruth Calloway", phone:"248-555-0773", email:"ruth.c@email.com", type:"Seller", status:"Cold", city:"Southfield", zip:"48076", address:"26000 Lahser Rd", lastContact:"2025-03-28", nextFollowUp:"2025-05-30", notes:"FSBO, curious about pricing", calls:1, source:"FSBO", birthday:"1962-02-18", dnc:false, streak:0, tags:["FSBO"], aiScore:18, aiMemory:null, transaction:null },
  { id:7, name:"Loretta Banks", phone:"248-555-0558", email:"loretta.b@email.com", type:"Seller", status:"Hot", city:"Oak Park", zip:"48237", address:"14000 W 10 Mile Rd", lastContact:"2025-05-24", nextFollowUp:"2025-05-26", notes:"Divorce situation, needs to sell fast", calls:6, source:"PropStream", birthday:"1971-04-15", dnc:false, streak:4, tags:["Motivated"], aiScore:91, aiMemory:null, transaction:{ stage:"Active Listing", closingDate:"2025-06-30", address:"14000 W 10 Mile Rd, Oak Park", price:"$285,000", milestones:[{label:"Listing Agreement",done:true},{label:"Photos Scheduled",done:true},{label:"Listed on MLS",done:false},{label:"Offer Received",done:false},{label:"Under Contract",done:false},{label:"Inspection",done:false},{label:"Clear to Close",done:false},{label:"Closed",done:false}] } },
];

const SEED_INVESTORS = [];
  { id:101, name:"Raymond Cole", phone:"313-555-0811", email:"r.cole@invest.com", status:"Active", pipeline:"Reviewing Deals", city:"Detroit", zip:"48202", cashBuyer:true, budgetMin:50000, budgetMax:300000, propertyTypes:["Multifamily","Single Family"], preferredAreas:["Detroit","Oak Park","Ferndale"], riskTolerance:"Moderate", expectedROI:15, timeline:"30-60 days", pastDeals:4, availableCapital:350000, deployedCapital:620000, avgDealSize:155000, dealStructure:"Cash", minCashOnCash:10, minCapRate:8, minIRR:15, exitStrategy:"Hold", holdTime:"5+ years", rehabTolerance:"Light", debtTolerance:"Low", speedToClose:"Fast", responseRate:85, commStyle:"Text", personality:"Analytical, numbers-focused", reliability:92, lastContact:"2025-05-20", notes:"Loves value-add multifamily. Rejects anything needing heavy rehab.", aiMemory:"Usually rejects deals with long timelines. Likes value-add multifamily under $250k. Fast closer when numbers check out.", tags:["Fast Closer","Multifamily","Cash Buyer"], activityFeed:[] },
  { id:102, name:"Debra Simmons", phone:"248-555-0934", email:"d.simmons@gmail.com", status:"Warm", pipeline:"Prospect", city:"Southfield", zip:"48076", cashBuyer:false, budgetMin:100000, budgetMax:500000, propertyTypes:["Commercial","Mixed Use"], preferredAreas:["Southfield","Ferndale","Royal Oak"], riskTolerance:"Aggressive", expectedROI:20, timeline:"60-90 days", pastDeals:1, availableCapital:200000, deployedCapital:180000, avgDealSize:200000, dealStructure:"Financing", minCashOnCash:12, minCapRate:9, minIRR:18, exitStrategy:"Flip", holdTime:"Under 1 year", rehabTolerance:"Heavy", debtTolerance:"High", speedToClose:"Moderate", responseRate:60, commStyle:"Email", personality:"Aggressive, growth-oriented", reliability:70, lastContact:"2025-04-28", notes:"New investor, hungry for deals. Open to heavy rehab.", aiMemory:"Aggressive investor open to heavy value-add. Prefers commercial or mixed-use. Not a fast closer but motivated.", tags:["Aggressive","Commercial","New Investor"], activityFeed:[] },
];
...
export default function ClientFlowCRM() {
  ...
  const runRevenueEngine = async()=>{
    ...
    try {
      ...
      const text=await callClaude("You are an autonomous revenue engine for a solo real estate agent. Analyze the pipeline and return ONLY valid JSON: {\"missedMoney\":[{\"issue\":\"string\",\"fix\":\"string\",\"urgency\":\"High|Medium|Low\"}],\"hotOpportunities\":[{\"name\":\"string\",\"reason\":\"string\",\"action\":\"string\"}],\"pipelineWarnings\":[{\"warning\":\"string\",\"detail\":\"string\"}],\"topPriority\":\"1 sentence\",\"weeklyForecast\":\"1 sentence\"}",`Pipeline: ${summary}. Total:${activeLeads.length},Hot:${pipeline.Hot.length},Warm:${pipeline.Warm.length},Cold:${pipeline.Cold.length},Overdue:${activeLeads.filter(l=>daysSince(l.lastContact)>7).length}.`,1500);
  ...
  const parseBuyBox = async(rawText,invId)=>{
    try {
      const text=await callClaude("Parse this investor buy box statement into structured criteria. Return ONLY valid JSON: {\"propertyTypes\":[],\"preferredAreas\":[],\"budgetMin\":0,\"budgetMax\":0,\"minROI\":0,\"rehabTolerance\":\"None|Light|Moderate|Heavy\",\"cashBuyer\":true,\"notes\":\"string\"}",`Statement: "${rawText}"`);
  ...
  return (
    <div style={{background:"#09090e",minHeight:"100vh",color:"#f0eee8",fontFamily:"'DM Sans','Helvetica Neue',sans-serif",fontSize:14}}>
        ...
        <div style={{maxWidth:1120,margin:"0 auto",padding:"0 14px"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",height:54}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div>
                <div style={{fontWeight:900,fontSize:15,letterSpacing:-0.5,fontFamily:"inherit"}}>
                  <span style={{color:"#f0eee8"}}>Client</span><span style={{color:"#1db954"}}>Flow</span>
                </div>
                {/* EDITABLE OFFICE */}
                {editingOffice
      ...
      <div style={{maxWidth:1120,margin:"0 auto",padding:"18px 14px"}}>
        ...
        {tab==="dashboard"&&<div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))",gap:10,marginBottom:20}}>
            {[["Total Leads",activeLeads.length,"#1db954"],["Due Today",callList.length,"#e05555"],["Hot",pipeline.Hot.length,"#e05555"],["Warm",pipeline.Warm.length,"#f5a623"],["Cold",pipeline.Cold.length,"#5b9cf6"],["Investors",investors.length,"#1db954"],["Transactions",transactions.length,"#4eca8b"]].map(([label,val,color])=>(
              <div key={label} style={{background:"#111118",borderRadius:12,border:`1px solid ${color}25`,padding:"14px 14px"}}>
              ...
              <div key={s} style={{background:"#111118",borderRadius:14,border:`1px solid ${c}28`,overflow:"hidden"}}>
                ...
                <div style={{padding:10,display:"flex",flexDirection:"column",gap:7}}>
                  ...
                  {pipeline[s].map(l=><div key={l.id} onClick={()=>setSelectedLead(l)} style={{display:"flex",alignItems:"center",gap:10,background:"#0d0d14",borderRadius:10,padding:"9px 11px",cursor:"pointer",border:"1px solid #1a1a24"}}>
                    ...
                    {l.aiMemory&&<span style={{fontSize:14}} title="Memory">🧠</span>}
                  </div>)}
                </div>
              </div>
            ))}
          ...
          {Object.entries(geoData).sort(([a],[b])=>a.localeCompare(b)).map(([city,zips])=>{
            ...
            return <div key={city} style={{marginBottom:22}}>
              <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10,paddingBottom:8,borderBottom:"1px solid #1a1a24"}}>
                ...
                <div style={{fontSize:12,color:"#55556a"}}>{all.length} leads · {Object.keys(zips).length} ZIP{Object.keys(zips).length!==1?"s":""}</div>
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(210px,1fr))",gap:10}}>
                {Object.entries(zips).sort(([a],[b])=>a.localeCompare(b)).map(([zip,group])=>{
                  ...
                  return <div key={zip} style={{background:"#111118",borderRadius:12,border:`1px solid ${hc}30`,padding:"12px 13px"}}>
                    ...
                    <div style={{height:4,background:"#1e1e28",borderRadius:2,overflow:"hidden",marginBottom:6}}><div style={{width:`${Math.min((h*3+w*2+c)/12,1)*100}%`,height:"100%",background:hc,borderRadius:2}}/></div>
                    <div style={{fontSize:11,color:"#55556a"}}>{group.slice(0,2).map(l=>l.name.split(" ")[0]).join(", ")}{group.length>2?` +${group.length-2}`:""}</div>
                  </div>;
                })}
              </div>
            </div>;
        ...
        {tab==="investors"&&<div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:18}}>
            <div><div style={{fontSize:20,fontWeight:900}}>Investor Network</div><div style={{color:"#8888a0",fontSize:13,marginTop:2}}>{investors.length} investors · AI-powered matching</div></div>
          ...
          <div style={{background:"#111118",borderRadius:14,border:"1px solid #1db95425",padding:"14px 16px",marginBottom:18}}>
            <div style={{fontSize:12,color:"#1db954",fontWeight:700,letterSpacing:0.8,marginBottom:10}}>🎯 AI DEAL MATCHING — describe a deal to find your best investors</div>
                ...
                <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:10}}>
                  ...
                  <div style={{flex:1}}>
                    <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
                      ...
                      <Pill label={inv.riskTolerance} color={inv.riskTolerance==="Aggressive"?"#e05555":inv.riskTolerance==="Moderate"?"#f5a623":"#5b9cf6"}/>
                    </div>
                    ...
                    <div style={{fontSize:11,color:"#55556a",marginTop:1}}>{inv.propertyTypes?.join(", ")} · {inv.preferredAreas?.slice(0,2).join(", ")}</div>
                  </div>
                  <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:4,flexShrink:0}}>
                    <div style={{fontSize:11,color:"#55556a"}}>{daysSince(inv.lastContact)}d ago</div>
                    <div style={{fontSize:12,color:"#1db954",fontWeight:700}}>{inv.reliability}% reliable</div>
                    <div style={{fontSize:11,color:"#8888a0"}}>{inv.pastDeals} deals</div>
                  </div>
                </div>
        ...
        {tab==="revenue"&&<div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:18}}>
            <div><div style={{fontSize:20,fontWeight:900}}>Revenue Engine</div><div style={{color:"#8888a0",fontSize:13,marginTop:2}}>AI scans your pipeline for missed money & opportunities</div></div>
          ...
          {revenueData&&<div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            {revenueData.pipelineWarnings?.length>0&&<div><div style={{fontSize:13,fontWeight:800,marginBottom:10,color:"#5b9cf6"}}>⚠ Pipeline Warnings</div><div style={{display:"flex",flexDirection:"column",gap:8}}>{revenueData.pipelineWarnings.map((w,i)=><div key={i} style={{background:"#111118",borderRadius:12,border:"1px solid #5b9cf620",padding:"12px 14px"}}><div style={{fontWeight:700,fontSize:13,marginBottom:3}}>{w.warning}</div><div style={{fontSize:12,color:"#8888a0"}}>{w.detail}</div></div>)}</div></div>}
          </div>}
        </div>}
      ...
      {showAddInvestor&&<Modal title="Add Investor" onClose={()=>setShowAddInvestor(false)} wide>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
          {[["name","Full Name *"],["phone","Phone *"],["email","Email"],["city","City"],["zip","ZIP"],["timeline","Timeline (e.g. 30-60 days)"]].map(([k,lbl])=>(
          ...
          <div style={{gridColumn:"1 / -1"}}><Label>Preferred Areas (comma separated)</Label><input value={newInv.preferredAreas} onChange={e=>setNewInv(p=>({...p,preferredAreas:e.target.value}))} placeholder="e.g. Detroit, Southfield, Oak Park" style={inputStyle}/></div>
          <div style={{gridColumn:"1 / -1"}}><Label>Notes / Buy Box Statement</Label><textarea value={newInv.notes} onChange={e=>setNewInv(p=>({...p,notes:e.target.value}))} rows={3} placeholder='e.g. "Only east-side Detroit, multifamily, no heavy rehab, need 15% IRR"' style={{...inputStyle,resize:"vertical"}}/></div>
...
function LeadDetail({lead,onClose,onText,onVM,onMemory,onDNC,onScore,onSave,onAdvisor,onTx,scoring,advisor}) {
  ...
  return <Modal title={lead.name} onClose={onClose} wide>
    <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14,background:"#0d0d14",borderRadius:12,padding:"12px 13px"}}>
      ...
      <div style={{flex:1}}><div style={{fontWeight:900,fontSize:16}}>{lead.name}</div><div style={{fontSize:13,color:"#8888a0"}}>{lead.phone}{lead.email?` · ${lead.email}`:""}</div><div style={{fontSize:12,color:"#55556a"}}>{lead.address?`${lead.address}, `:""}{lead.city}, MI {lead.zip}</div><div style={{fontSize:12,color:"#55556a"}}>Source: {lead.source}</div></div>
      <ScoreRing score={lead.aiScore}/>
    </div>
...
function InvestorDetail({investor,onClose,onSave,onParseBuyBox,onROI,roiSim,onText}) {
  ...
  return <Modal title={investor.name} onClose={onClose} wide>
    <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14,background:"#0d0d14",borderRadius:12,padding:"12px 13px"}}>
      ...
      <div style={{textAlign:"right"}}><div style={{fontSize:20,fontWeight:900,color:"#1db954"}}>{investor.reliability}%</div><div style={{fontSize:10,color:"#55556a"}}>reliability</div></div>
    </div>
    {/* Buy box */}
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,marginBottom:12}}>
      {[["Available",`$${(investor.availableCapital/1000).toFixed(0)}k`,"#1db954"],["Deployed",`$${(investor.deployedCapital/1000).toFixed(0)}k`,"#f5a623"],["Avg Deal",`$${(investor.avgDealSize/1000).toFixed(0)}k`,"#5b9cf6"]].map(([l,v,c])=><div key={l} style={{background:"#0d0d14",borderRadius:9,padding:"10px",textAlign:"center",border:`1px solid ${c}25`}}><div style={{fontSize:18,fontWeight:900,color:c}}>{v}</div><div style={{fontSize:10,color:"#55556a",marginTop:2}}>{l}</div></div>)}
    </div>
    {/* AI Memory */}
...
function VoicemailModal({lead,onClose}) {
  ...
  const aiRewrite=async()=>{setLoading(true);try{const r=await callClaude("Write a voicemail script for a real estate agent. Warm, professional, brief (20-30 seconds when read). Conversational, not salesy.",`Type:${type}. Lead:${lead.name.split(" ")[0]}, ${lead.type||""} in ${lead.city||""}. Source:${lead.source||""}. Notes:"${lead.notes||""}". Write the script.`);setScript(r);}catch{}setLoading(false);};
